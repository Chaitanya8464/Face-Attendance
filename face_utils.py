...
from models import db, Student # Import from models
...
def encode_faces():
    ...
    3. Saves the encoding to the Student table in the database.
    4. Also saves a pickled version of all encodings for quick lookup.
    """
...
def recognize_faces_from_frame(frame):
    ...
    Returns a list of recognized rolls and bounding boxes.
    """
